...
export const toolRegistry: Record<ToolType, EditorTool> = {
  select: {
    ...
    category: 'basic',
    shortcut: 'V',
    defaultSettings: { selectionMode: 'single', showBounds: true, snapToGrid: false },
  ...
  text: {
    ...
    category: 'content',
    shortcut: 'T',
    defaultSettings: { fontFamily: 'Helvetica', fontSize: 16, color: '#000000', bold: false, italic: false, underline: false, lineHeight: 1.2, textAlign: 'left' },
  ...
  highlight: {
    ...
    category: 'annotation',
    shortcut: 'H',
    defaultSettings: { color: '#FFFF00', opacity: 0.5, style: 'solid', blendMode: 'multiply' },
  ...
  rectangle: {
    ...
    category: 'shapes',
    shortcut: 'R',
    defaultSettings: { strokeColor: '#000000', fillColor: 'transparent', strokeWidth: 2, strokeStyle: 'solid', cornerRadius: 0 },
  ...
  circle: {
    ...
    category: 'shapes',
    shortcut: 'C',
    defaultSettings: { strokeColor: '#000000', fillColor: 'transparent', strokeWidth: 2, strokeStyle: 'solid' },
  ...
  line: {
    ...
    category: 'shapes',
    shortcut: 'L',
    defaultSettings: { strokeColor: '#000000', strokeWidth: 2, strokeStyle: 'solid' },
